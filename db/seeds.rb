...
#   Character.create(name: 'Luke', movie: movies.first)
  # Manga.create(title: 'Tokyo Ghoul', artist: "Sui Ishida", 
  #           desc: "The theme for Tokyo Ghoul is enacting change upon the 'sins' of the prior generations. You have people continuing to believe that Japan is just the same as it was 30 years ago, where the economy was flourishing and people only needed an education from a great college to succeed in life.",
